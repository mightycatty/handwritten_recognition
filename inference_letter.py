...
from config.config_letter import ModelConfig
import cv2
import random
nclass = 27
import string
...
basemodel_dir = 'D:\herschel\changrong\sequential_ocr\models\letter-02-0.17.h5'
...
def decode(pred):
    ...
    for i in range(len(pred_text)):
        if pred_text[i] != nclass - 1 and (
            ...
            char_list.append(string.ascii_uppercase[pred_text[i]])
